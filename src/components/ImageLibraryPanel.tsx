...
export default function ImageLibraryPanel({ onInsertImage }: ImageLibraryPanelProps) {
  ...
  return (
    <div className="p-4 space-y-4">
            ...
            {filteredImages.map(image => (
              <div
                ...
                className={`border rounded-lg overflow-hidden cursor-pointer transition-all hover:shadow-md ${
                  selectedImage === image.id ? 'ring-2 ring-primary shadow-lg' : ''
                }`}
              ...
              >
                ...
                <div className="p-2.5">
                  <div className="text-xs font-medium truncate mb-2.5" title={image.filename}>
                    {image.filename}
                  </div>
      ...
      {selectedImage && (
        <div className="border-t border-border pt-4">
          <h4 className="font-semibold text-xs mb-2">Image Details</h4>
          {(() => {
